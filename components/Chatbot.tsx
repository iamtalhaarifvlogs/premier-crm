  ...
  */
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex max-h-[85vh] w-[95%] top-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-3xl bg-white shadow-2xl md:right-6 md:w-[430px]">
